...
class Kayttoliittyma:
    ...
    def kaynnista(self):        
        ...
        while True:
            ...
            self.renderoija.renderoi(self.animoitu, self.algoritmi, self.alku, self.loppu, self.loytyi, self.aika)            
    ...
    def kasittele_tapahtumat(self):
        for tapahtuma in pygame.event.get():
            ...
            if tapahtuma.type == pygame.MOUSEBUTTONDOWN:
                x, y = tapahtuma.pos
                x_kartta = round((x-self.positio_kartta[0]) / self.skaalauskerroin)
                y_kartta = round((y-self.positio_kartta[1]) / self.skaalauskerroin)
            ...
            # Algoritmim valinta
                ...
                if tapahtuma.key == pygame.K_0:
                    ...
                    if tapahtuma.key == pygame.K_1:
                        ...
                        self.algoritmi = JumpPointSearch(self.ruudukko, self.alku, self.loppu)
